...
void populateNDC_Coefficients(GLfloat array[32*4], float radius, int numberOfVertices, float angle){
    ...
    for(int i=0; i<numberOfVertices*4; i+=8){
        ...
        array[i]   = (float) xCoordinate(0.5, current_angle);
        array[i+1] = (float) yCoordinate(0.5, current_angle);
        array[i+2] = 0.0f;
        array[i+3] = 1.0f;
        array[i+4] = (float) xCoordinate(radius, current_angle);
...
void populateColors(GLfloat array[32*4], int numberOfVertices){
    for(int i=0; i<numberOfVertices*4; i+=8){
        //R, G, B, A
        //External = red
          array[i]   = 1.0f;
...
//    };
    ...
    populateColors(color_coefficients, numberOfVertices);
